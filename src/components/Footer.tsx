        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-16">
          <div>
            ...
            <ul className="space-y-3 text-sm font-body text-[hsl(var(--footer-muted))]">
              ...
              <li className="flex items-center gap-2 hover:text-[hsl(var(--footer-fg))] transition-colors"><Globe className="w-4 h-4 shrink-0" /> {website}</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm font-body text-[hsl(var(--footer-muted))]">
              <li><a href="#about" className="hover:text-[hsl(var(--footer-fg))] hover:translate-x-1 inline-block transition-all duration-200">Giới thiệu</a></li>
              <li><a href="#auctions" className="hover:text-[hsl(var(--footer-fg))] hover:translate-x-1 inline-block transition-all duration-200">Tài sản đấu giá</a></li>
              <li><a href="#services" className="hover:text-[hsl(var(--footer-fg))] hover:translate-x-1 inline-block transition-all duration-200">Dịch vụ</a></li>
              <li><a href="#process" className="hover:text-[hsl(var(--footer-fg))] hover:translate-x-1 inline-block transition-all duration-200">Quy trình</a></li>
              <li><a href="/recruitment" className="hover:text-[hsl(var(--footer-fg))] hover:translate-x-1 inline-block transition-all duration-200">Tuyển dụng</a></li>
            </ul>
          </div>
